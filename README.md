...
O bot é utilizado para auxiliar na organização de um servidor de Minecraft, permitindo que administradores enviem:
...
Este projeto é privado e foi desenvolvido exclusivamente para uso interno.

O código deste repositório **não está autorizado para:**
...
Este software é propriedade do autor.  
Nenhuma parte deste projeto pode ser copiada, modificada, distribuída ou utilizada sem permissão.
